 ...
 * specific BRep topologic entity and entity index. Only the pointer 
 ...
 * specific BRep entity and it's index. Only the pointer of the 
 * appropriate type will be filled with a non-NULL value. Returns an 
 ...
 * an existing Attribute. If the name exists on the BRep entity then 
 * the Attribute is modified (unless the length is zero where it is 
